...
const Privacy = () => {
  ...
  return (
    <div className="bg-bg-page-color">
      ...
      ></div>
      <EachPageHeader title={titles[0]} subtitle={""} />
      <div className="max-w-6xl mx-auto p-4 md:p-8 bg-white rounded-xl shadow-lg my-10">
        <p>
          At Bio Baum Bauer, accessible from www.biobaumbauer.com, one of our
          main priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Bio Baum Bauer and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in Bio Baum Bauer. This policy is not applicable
        ...
        <h2 className="text-3xl font-semibold mt-6">Information we collect</h2>
        ...
        <p>
          Bio Baum Bauer follows a standard procedure of using log files. These
        ...
        <h2 className="text-3xl font-semibold mt-6">Cookies and Web Beacons</h2>
        ...
        <p>
          ...
          advertisements and links that appear on Bio Baum Bauer, which are sent
        ...
        <p>
          Bio Baum Bauer's Privacy Policy does not apply to other advertisers or
        ...
        <h2 className="text-3xl font-semibold mt-6">Children's Information</h2>
